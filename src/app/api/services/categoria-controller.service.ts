...
export class CategoriaControllerService extends BaseService {
  ...
  findById$Response(params: {
...
): Observable<StrictHttpResponse<CategoriaWithRelations>> {

    const rb = new RequestBuilder(this.rootUrl, CategoriaControllerService.CategoriaControllerFindByIdPath, 'get');
    if (params) {
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<CategoriaWithRelations>;
      })
    );
  }
...
): Observable<CategoriaWithRelations> {

    return this.findById$Response(params).pipe(
      map((r: StrictHttpResponse<CategoriaWithRelations>) => r.body as CategoriaWithRelations)
    );
  }
  ...
  replaceById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CategoriaControllerService.CategoriaControllerReplaceByIdPath, 'put');
    if (params) {
      rb.path('id', params.id, {});
  ...
  deleteById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CategoriaControllerService.CategoriaControllerDeleteByIdPath, 'delete');
    if (params) {
      rb.path('id', params.id, {});
    }
  ...
  updateById$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CategoriaControllerService.CategoriaControllerUpdateByIdPath, 'patch');
    if (params) {
      rb.path('id', params.id, {});
      rb.body(params.body, 'application/json');
    }
  ...
  find$Response(params?: {
...
): Observable<StrictHttpResponse<Array<CategoriaWithRelations>>> {

    const rb = new RequestBuilder(this.rootUrl, CategoriaControllerService.CategoriaControllerFindPath, 'get');
    if (params) {
      rb.query('filter', params.filter, {});
    }
    ...
    return this.http.request(rb.build({
      ...
      filter((r: any) => r instanceof HttpResponse),
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<Array<CategoriaWithRelations>>;
      })
    );
  }
...
): Observable<Array<CategoriaWithRelations>> {

    return this.find$Response(params).pipe(
      map((r: StrictHttpResponse<Array<CategoriaWithRelations>>) => r.body as Array<CategoriaWithRelations>)
    );
  }
  ...
  create$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CategoriaControllerService.CategoriaControllerCreatePath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  updateAll$Response(params?: {
    ...
    const rb = new RequestBuilder(this.rootUrl, CategoriaControllerService.CategoriaControllerUpdateAllPath, 'patch');
    if (params) {
      rb.query('where', params.where, {});
      rb.body(params.body, 'application/json');
    }
